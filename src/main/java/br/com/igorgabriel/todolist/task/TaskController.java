package br.com.igorgabriel.todolist.task;
...
import br.com.igorgabriel.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity update(@RequestBody TaskModel taskModel, @PathVariable UUID id, HttpServletRequest request){
        ...
        if(!task.getIdUser().equals(idUser)) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("O usuário não tem premissão para esta tarefa"); 
        }
